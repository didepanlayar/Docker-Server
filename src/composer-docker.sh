...
# This shell is for creating composer executables under Docker for the VSCode environment.
# Save to /usr/local/bin/composer and make it executable.
...
COMMAND="cd $RELATIVE_PATH && composer $ESCAPED_ARGS"
