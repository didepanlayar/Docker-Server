...
# This shell is for creating npm executables under Docker for the VSCode environment.
# Save to /usr/local/bin/npm and make it executable.
...
COMMAND="cd $RELATIVE_PATH && npm $ESCAPED_ARGS"
